...
const IntroPage: React.FC = () => {
  ...
  <p className="text-xl md:text-2xl font-medium text-[#2a2e6e]/80 max-w-2xl mb-8 leading-relaxed drop-shadow bg-white/60 rounded-2xl px-6 py-4 backdrop-blur-md shadow-lg">
    Dân chủ xã hội chủ nghĩa là nền dân chủ rộng rãi, bảo đảm quyền lực thực sự thuộc về nhân dân, được thực hiện thông qua nhà nước pháp quyền xã hội chủ nghĩa. Nhà nước pháp quyền xã hội chủ nghĩa ở Việt Nam là nhà nước của nhân dân, do nhân dân, vì nhân dân, quản lý xã hội bằng pháp luật, bảo đảm quyền con người, quyền công dân và thúc đẩy sự phát triển công bằng, tiến bộ.
  </p>
</div>
        ...
        >
          <img
            src={img3ng}
            alt="3 nhân vật"
            className="rounded-3xl shadow-2xl w-full max-w-xs md:max-w-md border-4 border-white/80 bg-white/60"
          />
        </motion.div>
      </div>
      {/* Section tiếp theo */}
